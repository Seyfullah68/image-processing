...
vid=cv2.VideoCapture("eye.mp4")# videoyu import ettik
...
while True: # videolar fotolardan olustugu icin sonsuz while dongusu actik
    ...
    faces=face_cascade.detectMultiScale(gray,1.3,5)# yuzlerin koordinatlarini bulduk
    ...
    eyes=eye_cascade.detectMultiScale(roi_gray)# gozlerin koordinatlarini bulduk
