...
while 1:
    ...
    if len(conturs)>0: # eger kontur varsa 
        ...
        en_sol=tuple(c[c[:,:,0].argmin()][0]) # konturlarin en sag, en sol,en alt ve en ust noktalarini bulduk
        ...
        cv2.line(roi,en_alt,en_sol,(255,0,0),2)
        cv2.line(roi,en_sol,en_ust,(255,0,0),2)
        cv2.line(roi,en_ust,en_sag,(255,0,0),2)
        cv2.line(roi,en_sag,en_alt,(255,0,0),2)
